...
export default function App() {
  ...
  const BodyGoals = () => {
    ...
    const addFood = () => {
      ...
      setFoodLog(prev => [...prev, { ...newFood, id: Date.now(), date: new Date().toISOString().split("T")[0] }]);
        ...
        {showAddFood && (
          <Card className="p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
              ...
              <input placeholder="What did you eat?" value={newFood.name} onChange={e => setNewFood(p => ({...p, name: e.target.value}))} className="border rounded-lg px-3 py-2 text-sm md:col-span-2" />
      ...
      <div className="space-y-5">
        <div className="flex items-center justify-between flex-col md:flex-row gap-3">
          <div>
            ...
            <p className="text-sm text-gray-400">Wealth Series · AI Tech · YouTube · Podcast</p>
          </div>
              ...
              <Card key={s} className="p-3">
                ...
                <div className="space-y-2">
                  {items.map(c => {
                    ...
                    return (
                      <div key={c.id} className="p-2 rounded-lg text-xs" style={{ backgroundColor: C.greige }}>
